class ClickSpark extends HTMLElement {
      ...
      let template = `
        <style>
          ...
          svg {
            ...
            position: absolute;
            rotate: -20deg;
            stroke: var(--click-spark-color,#FFADAD );
          }
        ...
        <svg width="30" height="30" viewBox="0 0 100 100" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
          ${Array.from(
            { length: 8 },
  ...
  const spark = document.querySelector("click-spark").shadowRoot.querySelector("svg");